...
class MicroPyServer(object):
    """ Async Worker MicroPython Server Class

    !!! This is a base class and not meant to be used directly !!!
    ...
    def __init__(self, debug=False):
        ...
        self.loop.create_task(self._run())  # Schedule ASAP
    ...
    async def _run(self):
        ...
        while True:
            ...
            await asyncio.sleep_ms(self.SERVER_CMD_SLEEP_MS)
